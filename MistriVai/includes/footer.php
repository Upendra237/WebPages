      ...
      <div class="lg:col-span-2">
        ...
        <div class="flex flex-wrap gap-2 mt-1">
          ...
          <a href="https://www.instagram.com/mistri_vai_079/" target="_blank" rel="noreferrer"
             class="w-9 h-9 border border-white/30 hover:border-[#C8A951] hover:text-[#C8A951] transition-colors rounded-sm flex items-center justify-center text-white/65" aria-label="Instagram">
          ...
          <a href="https://www.facebook.com/profile.php?id=61576128327754" target="_blank" rel="noreferrer"
             class="w-9 h-9 border border-white/30 hover:border-[#C8A951] hover:text-[#C8A951] transition-colors rounded-sm flex items-center justify-center text-white/65" aria-label="Facebook">
          ...
          <a href="https://www.youtube.com/@mistri_vai_079" target="_blank" rel="noreferrer"
             class="w-9 h-9 border border-white/30 hover:border-[#C8A951] hover:text-[#C8A951] transition-colors rounded-sm flex items-center justify-center text-white/65" aria-label="YouTube">
          ...
          <a href="https://www.tiktok.com/@mistri_vai_079" target="_blank" rel="noreferrer"
             class="w-9 h-9 border border-white/30 hover:border-[#C8A951] hover:text-[#C8A951] transition-colors rounded-sm flex items-center justify-center text-white/65" aria-label="TikTok">
          ...
          <a href="https://www.linkedin.com/company/107956858/" target="_blank" rel="noreferrer"
             class="w-9 h-9 border border-white/30 hover:border-[#C8A951] hover:text-[#C8A951] transition-colors rounded-sm flex items-center justify-center text-white/65" aria-label="LinkedIn">
          ...
          <a href="https://x.com/mistrivai79" target="_blank" rel="noreferrer"
             class="w-9 h-9 border border-white/30 hover:border-[#C8A951] hover:text-[#C8A951] transition-colors rounded-sm flex items-center justify-center text-white/65" aria-label="X (Twitter)">
